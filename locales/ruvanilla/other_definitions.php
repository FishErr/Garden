 ...
 * Description: A full translation to Russian including all default plugins and admin as of 2.0.17.10.
 * Author: Pavel Orlov <webdizg@gmail.com> http://quadrsomit.ru
 * Last changed: 2011-06-23
 * License: Creative Commons Attribution-ShareAlike 3.0 (CC BY-SA)
 */

$Definition['%1$s created an account for %4$s.'] = '%4$s создал аккуант для %1$s.';
...
$Definition['%s message'] = 'Сообщение %s';
...
$Definition['%s user(s) found.'] = 'пользователь %s не найден';
...
$Definition['About'] = 'Профайл участника';
...
$Definition['Activity.ConversationMessage.FullHeadline'] = '%1$s отправил(а) вам %8$s.';
$Definition['Activity.ConversationMessage.ProfileHeadline'] = '%1$s отправил(а) вам %8$s.';
...
$Definition['Activity.Join.FullHeadline'] = '%1$s, теперь участник нашего форума.';
$Definition['Activity.Join.ProfileHeadline'] = '%1$s, теперь участник нашего форума';
$Definition['Activity.JoinCreated.FullHeadline'] = '%3$s создал аккуант для %1$s.';
$Definition['Activity.JoinCreated.ProfileHeadline'] = '%3$s создал аккуант для %1$s.';
$Definition['Activity.JoinInvite.FullHeadline'] = '%1$s одобрил %4$s инвайтов';
$Definition['Activity.JoinInvite.ProfileHeadline'] = '%1$s одобрил %4$s инвайтов';
$Definition['Activity.NewDiscussion.FullHeadline'] = '%1$s создал(а) новое %8$s.';
$Definition['Activity.NewDiscussion.ProfileHeadline'] = '%1$s создал(а) новое %8$s.';
...
$Definition['Add a Comment'] = 'Комментировать';
$Definition['Add Category'] = 'Добавить категорию';
$Definition['Add Comment'] = 'Отправить';
$Definition['Add Info &amp; Create Account'] = 'Добавить информацию &amp; Создать аккуант';
...
$Definition['All of the user content will be replaced with a message stating the user has been deleted.'] = 'Все сообщения пользователя будут заменты на то, что пользователь был удален.';
$Definition['Allow'] = 'Одобрить';
$Definition['Allow other members to see your email?'] = 'Показывать ваш email другим пользователям?';
...
$Definition['Application'] = 'Приложения';
$Definition['Application ID'] = 'ID Приложения';
$Definition['Application Secret'] = 'Секрет приложения [?]';
...
$Definition['Approval'] = 'С одобрением';
...
$Definition['at'] = 'at';
$Definition['Authentication'] = 'Аутенфикация';
$Definition['Authors can always edit their posts'] = 'Автор всегда может редактировать свой пост';
$Definition['Authors can edit for 1 day after posting'] = 'Автор не сможет редактировать свой пост спустя 1 сутки после публикации';
$Definition['Authors can edit for 1 month after posting'] = 'Автор не сможет редактировать свой пост спустя 1 месяц после публикации';
$Definition['Authors can edit for 1 week after posting'] = 'Автор не сможет редактировать свой пост спустя 1 неделю после публикации';
$Definition['Authors can edit for 15 minutes after posting'] = 'Автор не сможет редактировать свой пост спустя 15 минут после публикации';
$Definition['Authors can edit for 30 minutes after posting'] = 'Автор не сможет редактировать свой пост спустя 30 минут после публикации';
$Definition['Authors can edit for 5 minutes after posting'] = 'Автор не сможет редактировать свой пост спустя 5 минут после публикации';
...
$Definition['Back to Discussions'] = 'Назад, ко всем темам';
$Definition['Banned'] = 'Забанен';
$Definition['Banner'] = 'Название и лого';
$Definition['Banner Logo'] = 'Лого сайта';
...
$Definition['%s changed %s\'s permissions.'] = '%s изменил %s\'s настройки доступа';
...
$Definition['By uploading a file you certify that you have the right to distribute this picture and that it does not violate the Terms of Service.'] = 'Загружая изображение вы автоматически подтверждаете, что имеете право распространять загружаемое изображение и не нарушаете <strong>условия пользования</strong>.';
...
$Definition['Categories &amp; Discussions'] = 'Категории &amp; Обсуждаемое';
...
$Definition['Category Url:'] = 'URL адресс:';
...
$Definition['Check all permissions that apply for each role'] = 'Проверьте все разрешения, которые применяются в каждой группе.';
$Definition['Check all permissions that apply to this role:'] = 'Проверьте все разрешения, которые относятся к этой группе:';
$Definition['Check all roles that apply to this user:'] = 'Проверьте все группы, в которых может состоять этот пользователь:';
$Definition['Choose a locale pack'] = 'Выбирите локализацию';
$Definition['Choose a name to identify yourself on the site.'] = 'Выберете имя для идентификации себя на сайте';
$Definition['Choose and configure your forum\'s authentication scheme.'] = 'Выберите и настройте схему авторизации на форуме';
$Definition['Choose how to handle all of the content associated with the user account for %s (comments, messages, etc).'] = 'Как обрабатывать содержимое для %s ? (комментарии, уведомления, и т.д.).';
$Definition['Choose who can send out invitations to new members:'] = 'Укажите кто может посылать инвайты новым пользователям:';
...
$Definition['Click here to apply it.'] = 'Кликните тут для подтверждения';
$Definition['Close'] = 'Закрыть';
$Definition['Comment'] = 'Комментарии';
$Definition['Comment by %s'] = 'Комментарий %s';
$Definition['comment(s)'] = 'комментарий(ев)';
$Definition['Comments'] = 'Комментарии';
$Definition['Comments per Page'] = 'Комментариев на странице';
$Definition['Configure an Authenticator'] = 'Настройки Authenticator';
$Definition['Configure how nested categories are displayed to users.'] = 'Настройте количество вложенных категорий показываемых пользователям';
$Definition['Configuring Vanilla\'s Homepage'] = 'Настройте домашнюю страницу своего сайта';
$Definition['Confirm'] = 'Подтверждение';
$Definition['Confirm Email'] = 'Подтвердите email';
$Definition['Confirm Password'] = 'Подтвердите пароль';
$Definition['Connect'] = 'Соеденение';
...
$Definition['Current Authenticator'] = 'Актуальный Authentifizierungs-Plugin';
...
$Definition['Date.DefaultDayFormat'] = '%e-%m-%y, %H:%M';
$Definition['Date.DefaultYearFormat'] = '%B %Y';
$Definition['Date.DefaultTimeFormat'] = 'Сегодня, %H:%M';
...
$Definition['Your changes have been saved successfully.'] = 'Ваши настройки были сохранены.';
...
$Definition['discussion'] = 'теме';
$Definition['Discussion & Comment Editing'] = 'Редактирование Тем & Комментариев';
...
$Definition['Don\'t have an account? %s'] = 'Нет аккуанта? %s';
$Definition['Don\'t Refresh'] = 'Не обновлять';
$Definition['Don\'t use Categories'] = 'Не использовать категории';
$Definition['dot'] = 'dot';
$Definition['Drag and drop the categories below to sort and nest them.'] = 'Схватите и перетащите категорию для сортировке в списке.';
...
$Definition['Edit'] = 'Редактировать';
$Definition['Edit Account'] = 'Редактировать аккуант';
...
$Definition['Edit My Account'] = 'Редактировать мой аккуант';
$Definition['Edit My Thumbnail'] = 'Изменить мой аватар';
$Definition['Edit Preferences'] = 'Изменить уведомления';
...
$Definition['Email sent from the application will be addressed from the following name and address'] = 'Использовать в качестве отправителя следующий адресс электронной почты:';
...
%1$s приглашает присоединиться %2$s. Если вы хотите присоедниться, то перейдите по ссылке:
...
$Definition['Enable Content Flagging'] = 'Aktiviere melden von Inhalten';
...
$Definition['Enter your Email address'] = 'Адресс вашей почты';
...
$Definition['ErrorPermission'] = 'Простите, у вас нет разрешения';
$Definition['ErrorPluginDisableRequired'] = 'Вы не можете отключить плагин {0}, так как плагин зависит от {1}.';
$Definition['ErrorPluginEnableRequired'] = 'Прежде чем включить этот плагин, нужно включить этот: {0} плагин.';
...
$Definition['Flagged Items'] = 'Помеченные вещи';
$Definition['Flagging Settings'] = 'Содержание отчета - Настройки';
$Definition['Flood Control'] = 'Антиспам';
$Definition['Follows'] = 'Следят';
$Definition['For more help on localization check out the page <a href="%s">here</a>.'] = 'Для получения большей помощи по локализациям изучите<a href="%s">эту</a> страницу.';
...
$Definition['Garden.Import.InputInstructions'] = 'Email und Passwort des Admins der Import-Quelle.';
$Definition['Garden.Import.Overwrite.Description'] = 'Warnung: Alle Daten in diesem Forum werden uberschrieben.';
$Definition['Garden.Registration.DefaultRoles'] = 'standard Rolle';
...
$Definition['Get More Applications'] = 'Больше приложений';
$Definition['Get more information on creating custom routes'] = 'Читайте более подробную информацию о перенаправлениях';
$Definition['Get More Plugins'] = 'Больше плагинов';
$Definition['Get More Themes'] = 'Больше тем';
$Definition['Go'] = '&rarr;';
...
$Definition['GuestModule.Message'] = 'Похоже, вы новенький! Чтобы пообщаться с нами, кликните на одну из кнопок ниже :)';

$Definition['he'] = 'её';
$Definition['Heads Up! This is a special role that does not allow active sessions. For this reason, the permission options have been limited to "view" permissions.'] = 'Dies ist eine spezielle Rolle, die keine aktiven Sitzungen erlaubt. Daher sind die Rechteeinstellungen auf Rechte zur "Ansicht" eingeschrankt.';
$Definition['her'] = 'ее';
...
$Definition['I agree to the <a id="TermsOfService" class="Popup" target="terms" href="%s">terms of service</a>'] = 'Я согласен с <a id="TermsOfService" class="Popup" target="terms" href="%s">правилами</a> форума';
$Definition['I agree to the <a id="TermsOfService" class="Popup" target="terms" href="/dashboard/home/termsofservice">terms of service</a>'] = 'Я согласен с <a id="TermsOfService" class="Popup" target="terms" href="/dashboard/home/termsofservice">правилами</a> форума';
$Definition['I remember now!'] = 'Ой, я вспомнил пароль!';
...
$Definition['Invitation'] = 'С инвайтами';
$Definition['Invitation Code'] = 'Код инвайта';
$Definition['Invitations can be sent from users\' profile pages.'] = 'Если включена регистрация по инвайтам, на страницах профилей пользователей отображается дополнительная ссылка, называемая <a href="%s" class="Popup">Мои приглашения</a>';
$Definition['Invitations per month'] = 'Инвайтов в месяц';
...
$Definition['Invited by'] = 'Приглашен';
$Definition['It is a good idea to keep the maximum number of characters allowed in a comment down to a reasonable size.'] = 'Опция ниже, поможет вам сократить максимальное количество символов в комментарии до разумного размера.';
...
$Definition['Locale info file settings.'] = '<p>Vor dem Generieren einer zip-Datei mit den gesammelten Daten bitte die unten stehenden Felder ausfullen.</p> <p>Klicke <a href="%s">hier</a> zum Downloaden der Datei.</p>';
...
$Definition['Manage Roles & Permissions'] = 'Управление группами и разрешениями';
...
$Definition['Max Comment Length'] = 'Максимальное кол-во символов в комментарии:';
...
$Definition['Message'] = 'Сообщение';
$Definition['Messages'] = 'Уведомления';
$Definition['Messages can appear anywhere in your application.'] = 'Уведомления (сообщения) могут быть отображены в любом месте сайта для пользователей, например, для информирования о новостях. На этой странице можно управлять ими с помощью перетаскивания.';
...
$Definition['About Vanilla Statistics'] = 'Об этом плагине';
$Definition['Statistics'] = 'Статистика';
$Definition['The Vanilla Statistics plugin turns your forum\'s dashboard into an analytics reporting tool'] = 'Плагин статистики для Vanilla показывает в консоли графики активности на вашем форуме, на основе данных записаных движком форума. Вы можете <a href="http://vanillaforums.org/docs/vanillastatistics">получить больше информации об этом плагине</a> в его документации.';
$Definition['%s mentioned %s in a %s.'] = '%s упомянул вас в комментарии';
...
$Definition['No default roles.'] = 'Группа по умолчанию настроена неправильно. Кликните сюда: %s, что бы исправить это.';
$Definition['No discussions were found.'] = 'Не найденно ни одной темы';
$Definition['None'] = 'Нет';
$Definition['Not Authorized (401)'] = 'Неавторизированы (401)';
$Definition['Not Found (404)'] = 'Не найдено (404)';
...
$Definition['Notify me when people reply to my wall comments.'] = 'Сообщать об ответах на мои комментарии на стене';
...
Кто-то просить сбросить %2$s пароль. Если это были вы, пройдите по ссылке ниже:
...
$Definition['Please choose an authenticator to configure.'] = 'Выберите плагин аутенфикации для настройки';
...
$Definition['PluginHelp'] = 'Плагины позволяют изменять функциональность вашего сайта<br />Для установки плагина поместите его в папку: %s и затем включите его на этой странице';
$Definition['Plugins'] = 'Плагины';
$Definition['Popular'] = 'Популярные';
$Definition['Popular Discussions'] = 'Популярные темы';
$Definition['Popular Tags'] = 'Популярные теги';
$Definition['Position'] = 'Позиция';
$Definition['Post Comment'] = 'Отправить';
$Definition['Post Discussion'] = 'Отправить';
$Definition['Powered by Vanilla'] = 'Vanillaforums.org. <a href="http://vanillaforum.ru/">Vanilla Россия.</a>';
$Definition['Prevent spam on your forum by limiting the number of discussions &amp; comments that users can post within a given period of time.'] = 'Избегайте спама и флуда на форуме, путем ограничения количества новых обсужедний и комментариев в еденицу времени.';
...
$Definition['Recent Activity'] = 'Прямой эфир';
...
$Definition['Remember me on this computer'] = 'Запомнить меня';
...
$Definition['Roles & Permissions'] = 'Группы и разрешения';
...
$Definition['Save Comment'] = 'Отредактировать';
...
$Definition['Select an image on your computer (2mb max)'] = 'Выберите изображение с вашего компьютера (2mb максимум)';
$Definition['Select the file to import'] = 'Выбирите файл для импорта';
$Definition['Send %s a Message'] = 'Послать %s сообщение';
$Definition['Send Again'] = 'Послать снова';
...
$Definition['Sign In with Twitter'] = 'Войти с помощью Twitter\a';
$Definition['Sign Out'] = 'Выйти';
$Definition['Sign Up'] = 'Зарегистрироваться';
$Definition['SignIn'] = 'Вход';
$Definition['Sink'] = '<span title="Не поднимать тему при поступлении новых комментариев">Дать утонуть</span>';
...
$Definition['Start your First Discussion'] = 'Starte deine erste Diskussion';
$Definition['Started by %1$s'] = 'Опубликовал %1$s';
$Definition['Status'] = 'Статус';

$Definition['Tagged'] = 'Теги темы';
$Definition['Tagged with '] = 'Теги с ';
$Definition['Tagging'] = 'Тэггиорование';
$Definition['Tags'] = 'Тэги';
$Definition['Tags are keywords that users can assign to discussions to help categorize their question with similar questions.'] = 'Tags sind Schlagworter, die Nutzer Diskussionen zuweisen konnen. Diese helfen dabei Diskussionen besser zu kategorisieren und mit ahnliche Diskussionen zu verbinden.';
...
$Definition['The addon could not be enabled because it generated a fatal error: <pre>%s</pre>'] = 'Аддон не может быть активировать потому что он выдает фатальную ошибку: <pre>%s</pre>';
...
$Definition['The banner title appears on the top-left of every page. If a banner logo is uploaded, it will replace the banner title on user-facing forum pages.'] = 'Название сайта отображается на каждой странице в левом верхнем углу (в зависимости от выбранной темы оформления), а так же в заголовках страниц.<br><br> Ещё вы можете загрузить логотип, вместо названия сайта.';
...
$Definition['The page you were looking for could not be found.'] = 'Страница, которую вы ищете, на может быть найдена.';
$Definition['The user and all related content has been deleted.'] = 'Пользователь и все с ним связанное было удалено.';
$Definition['The user content will be completely deleted.'] = 'Контент пользователя будет полностью удален';
...
$Definition['There are no tags in the system yet.'] = 'В системе еще нет тегов.';
$Definition['This action cannot be undone.'] = 'Это действие не может быть отменено.';
$Definition['This category has custom permissions.'] = 'Данная категория содержит особые права.';
...
$Definition['This plugin allows users to sign in with their Google accounts. <b>Make sure you click Settings after enabling this plugin to enable Google signin</b>.'] = 'Этот плагин позволяет пользователю войти на сайт с помощью Google. <b>После активации перейдите в настройки чтобы включить вход по Google.</b>.';
...
$Definition['Twitter Connect allows users to sign in using their Twitter account.'] = 'Twitter Connect позволяет пользователю войти на форум с помощью твиттер аккуанта. <b>Необходима активация приложения на сайте Twitter\'a чтобы плагин работал правильно.</b>';
$Definition['Twitter Settings'] = 'Настройки входа через Twitter';
$Definition['Type'] = 'Тип';
$Definition['Closed'] = 'Закрыто';
$Definition['&larr; All Discussions'] = '&larr; Назад ко всем темам';
...
$Definition['To send another confirmation email click <a href="%s">here</a>.'] = 'Для того, чтобы послать другое письмо активации кликните <a href="%s">тут</a>.';
$Definition['You need to confirm your email address.'] = 'Вам нужно подтвердить email адресс. Для того, чтобы повторно послать письмо активации кликните <a href="/entry/emailconfirmrequest">тут</a>.';

$Definition['Unannounce'] = 'Убрать объявление';
$Definition['Unbookmark'] = 'Убрать из закладок';
$Definition['Uninvite'] = 'Отменить приглашение';
$Definition['Unlimited'] = 'Неограниченно';
$Definition['Unsink'] = 'Не дать утонуть';
...
$Definition['Use the content at this url as your homepage.'] = 'Главная страница это то, что посетители будут видеть, заходя по адресу <b>%s</b>. По умолчанию показываются "Все темы", но вы можете использовать все, что вам придет в голову. Вот несколько популярных вариантов: ';
...
$Definition['UsernameError'] = 'Имена пользователей могут содержать только буквы, цифры и знаки подчеркивания и должен быть от 3 до 20 символов.';
$Definition['Users'] = 'Пользователи';

$Definition['ValidateBoolean'] = '%s - неправильный ответ';
$Definition['ValidateConnection'] = 'При указанных параметрах не может быть установленно соеденение с базой данных. База данных отдает следующие ошибки: <code>%s</code>';
$Definition['ValidateDate'] = '%s - неправильная дата.';
$Definition['ValidateDecimal'] = '%s - неверная дробь.';
$Definition['ValidateEmail'] = '%s не корректный адресс почты.';
...
$Definition['ValidateRequired'] = 'Необходим %s.';
...
$Definition['Warning: Loading tables can be slow.'] = '<b>Внимание</b>: Конфигурация сервера не поддерживает быструю загрузку. Если вы пытаетесь импортировать большой файл (> 200.000 комментариев), то вам лучше обновить конфигурацию сервера. Для боллее подробной информации <a href="http://vanillaforums.com/porter">перейдите сюда</a>';
$Definition['We will attempt to use the local mail server to send email by default. If you want to use a separate SMTP mail server, you can configure it below.'] = 'Мы будем пытаться использовать локальный почтовый сервер для отправки электронной почты по умолчанию. Если вы хотите использовать отдельный почтовый сервер SMTP, вы можете настроить его ниже.';
$Definition['Welcome Aboard!'] = 'Добро пожаловать к нам!';
$Definition['What\'s the Buzz?'] = 'Статистика форума';
...
$Definition['Panel Box'] = 'Панель уведомления';
...
$Definition['Make sure you select at least one item before continuing.'] = 'Удостоверьтесь, что вы выбрали хотябы одну запись перед редактированием.';
$Definition['BanType'] = 'Тип Бана';
$Definition['Ban Value'] = 'Значение';
$Definition['Date'] = 'Дата';
$Definition['No Items Selected'] = 'Ничего не выбранно';
...
$Definition['You can always use your password at<a href="%1$s">%1$s</a>.'] = 'Вы всегда можете использовать пороль на <a href="%1$s">%1$s</a>.';
...
$Definition['In seconds'] = 'В секунду';
$Definition['Rate of refresh'] = 'Норма обновления';
$Definition['Save'] = 'Сохранить';
...
//Файл аплод
$Definition['Attach a file'] = 'Припкрепить файл';
...
$Definition['%s said'] = '%s сказал';

//Tag
$Definition['Forum'] = 'Форум';
$Definition['Tagging'] = 'Тэги';
...
$Definition['Tags are keywords that users can assign to discussions to help categorize their question with similar questions.'] = 'Пользователи могут добавлять тэги и ключевые слова для улучшения навигации по связанным дискуссиям.';
$Definition['Plugins.Tagging.Enabled'] = 'Плагин "Теги" Включен';
$Definition['%s tags in the system'] = '%s тэгов в системе';
$Definition['Click a tag name to edit. Click x to remove.'] = 'Кликните на тэг для редактирования. Кликните на х для удаления.';
$Definition['There are no tags in the system yet.'] = 'В системе нет ни одного тэга, пока что.';
...
$Definition['Click accept or reject beside an answer.'] = 'Кликните "Одобрить" или "Отклонить" для того что бы пометить ответ на вопрос.';
$Definition['This answer was Accepted.'] = 'Этот ответ подошел.';
$Definition['This answer was %s.'] = 'Этот ответ был %s';
$Definition['Accepted'] = 'Одобрен';
...
$Definition['Mark Read'] = '<span title="Отметить посты в этой категории прочитанными">Прочитанно</span>';
...
$Definition['Users will be assigned to this role until they\'ve confirmed their email addresses.'] = 'Пользователи будут отнесены к этой группе, пока не подтвердят свой email адресс';
...
$Definition['About.DisableStatistics'] = 'Если же вам по каким то причинам необходимо отключить этот плагин, отредактируйте файл config.php, добавив (или изменив) строку <code>$Configuration[\'Garden\'][\'Analytics\'][\'Enabled\'] = FALSE;</code>';
...
$Definition['You already have an account here.'] = 'У вас уже есть аккаунт здесь';
...
$Definition['Kick-start your community and increase user engagement.'] = 'Быстро настрой и начинай приглашать пользователей в свое сообщество';
$Definition['Vanilla is the simplest, most powerful community platform in the world. It\'s super duper easy to use. We suggest you start by watching this introductory video and continue with the steps below. Enjoy!'] = 'Vanilla это простая и самая мощная форумная платформа в мире! Она супер-пупер легка в использовании. Вы можете убедиться в этом посмотрев видео, которые мы сделали для вас. Наслаждайтесь!';
$Definition['Encourage your friends to join your new community!'] = 'Позови своих друзей учавствовать в обсжудениях на форуме!';
$Definition['Hi Pal!
